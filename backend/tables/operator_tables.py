...
class OperatorsTable(tables.Table):
    ...
    operator_first_name = tables.Column(
        verbose_name='Name',
        attrs={
            'search_filter': 'input-text',
        }
    )
    operator_phone_number = tables.Column(
        verbose_name='Phone Number',
        attrs={
            'search_filter': 'input-text',
        }
    )
    operator_organization = tables.Column(
    ...
    @staticmethod
    def render_operator_first_name(record):
        return str(record.operator_first_name) + ' '+ str(record.operator_last_name)

    @staticmethod
    def render_operator_phone_number(record):
        return record.operator_phone_number
    ...
    def render_operator_organization_id(record, auth_permissions):
        ...
        try:
            ...
            return record.operator_organization
