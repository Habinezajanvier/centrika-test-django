INSERT INTO `access_permissions` (`access_permission_name`, `access_permission_details`, `access_permission_created_at`, `access_permission_updated_at`) VALUES 
        ...
        ('settings-view', 'settings-view', 1560853801, 1560853801);
INSERT INTO `access_permissions` (`access_permission_name`, `access_permission_details`, `access_permission_created_at`, `access_permission_updated_at`) VALUES 
...
(2, 'system@qtsoftwareltd.com', 'hdYuTBbYj6_Lho3REkSYJUJkMQqlDdIH', '$2y$13$/3Ur0L1z7b3ma4RDwdld8.DQ4/9GmmRbpscCXL1z42o8cNMb6UfZK', '', 2, 0, 'QTS', 'Support', 0, 'support@qtsoftwareltd.com', '+250726875122', '', NULL, NULL, '', '0', '::1', 1570112959, 1, 1590351988, 1, 3);
