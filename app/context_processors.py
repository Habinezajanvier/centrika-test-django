...
def global_settings(request):
    ...
    return {
        ...
        'ACCESS_PERMISSION_ORGANIZATION_CREATE': settings.ACCESS_PERMISSION_ORGANIZATION_CREATE,
        'ACCESS_PERMISSION_ORGANIZATION_UPDATE': settings.ACCESS_PERMISSION_ORGANIZATION_UPDATE,
        'ACCESS_PERMISSION_ORGANIZATION_DELETE': settings.ACCESS_PERMISSION_ORGANIZATION_DELETE,
        'ACCESS_PERMISSION_ORGANIZATION_VIEW': settings.ACCESS_PERMISSION_ORGANIZATION_VIEW,
        # Model Titles
