...
def global_settings(request):
    ...
    return {
        ...
        'MODEL_AGENTS_PLURAL_TITLE': settings.MODEL_AGENTS_PLURAL_TITLE,
        'MODEL_AGENTS_SINGULAR_TITLE': settings.MODEL_AGENTS_SINGULAR_TITLE,
        'MODEL_AGENT_FLOATS_CARDS_PLURAL_TITLE': settings.MODEL_AGENT_FLOATS_CARDS_PLURAL_TITLE,
        'MODEL_AGENT_FLOATS_CARDS_SINGULAR_TITLE': settings.MODEL_AGENT_FLOATS_CARDS_SINGULAR_TITLE,
        'MODEL_AGENT_FLOATS_TICKETS_PLURAL_TITLE': settings.MODEL_AGENT_FLOATS_TICKETS_PLURAL_TITLE,
        'MODEL_AGENT_FLOATS_TICKETS_SINGULAR_TITLE': settings.MODEL_AGENT_FLOATS_TICKETS_SINGULAR_TITLE,
