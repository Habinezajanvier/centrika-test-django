...
def global_settings(request):
    ...
    return {
        ...
        'BACKEND_SECTION_TICKETS': settings.BACKEND_SECTION_TICKETS,
        ...
        'ACCESS_PERMISSION_TICKETS_CREATE': settings.ACCESS_PERMISSION_TICKETS_CREATE,
        'ACCESS_PERMISSION_TICKETS_UPDATE': settings.ACCESS_PERMISSION_TICKETS_UPDATE,
        'ACCESS_PERMISSION_TICKETS_DELETE': settings.ACCESS_PERMISSION_TICKETS_DELETE,
        'ACCESS_PERMISSION_TICKETS_VIEW': settings.ACCESS_PERMISSION_TICKETS_VIEW,
        # Model Titles
        ...
        'MODEL_CARDS_PLURAL_TITLE': settings.MODEL_CARDS_PLURAL_TITLE,
        'MODEL_CARDS_SINGULAR_TITLE': settings.MODEL_CARDS_SINGULAR_TITLE,
        'MODEL_CARD_BALANCE_PLURAL_TITLE': settings.MODEL_CARD_BALANCE_PLURAL_TITLE,
        'MODEL_CARD_BALANCE_SINGULAR_TITLE': settings.MODEL_CARD_BALANCE_SINGULAR_TITLE,
        'MODEL_CARDS_LOGS_PLURAL_TITLE': settings.MODEL_CARDS_LOGS_PLURAL_TITLE,
        'MODEL_CARDS_LOGS_SINGULAR_TITLE': settings.MODEL_CARDS_LOGS_SINGULAR_TITLE,
        'MODEL_TICKETS_PLURAL_TITLE': settings.MODEL_TICKETS_PLURAL_TITLE,
        'MODEL_TICKETS_SINGULAR_TITLE': settings.MODEL_TICKETS_SINGULAR_TITLE,
        # Template Colors
