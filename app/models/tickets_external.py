...
class Tickets_External(models.Model):
    ...
    ticket_travel_date = models.DateField('Travel Date', blank=True, null=True)
    ticket_travel_time = models.TimeField('Travel Time', blank=True, null=True)
    ticket_travel_datetime = models.DateTimeField('Travel Datetime', max_length=255, blank=False, default='')
    ...
    ticket_card_response = models.CharField('Card Response', max_length=255, blank=False, default='')
    ticket_card_transaction_id = models.CharField('Card Transaction Id', max_length=255, blank=False, default='')
    ticket_card_transaction_status = models.CharField('Card Transaction Status', max_length=255, blank=False, default='')
