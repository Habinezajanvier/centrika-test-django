...
class Agent_Floats_Tickets(models.Model):
    TITLE = settings.MODEL_AGENT_FLOATS_TICKETS_PLURAL_TITLE
    SINGULAR_TITLE = settings.MODEL_AGENT_FLOATS_TICKETS_SINGULAR_TITLE
